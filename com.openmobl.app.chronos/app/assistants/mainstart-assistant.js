...
function MainstartAssistant()
{

}

MainstartAssistant.prototype.aboutToActivate = function(callback)
{
    callback.defer(); //makes the setup behave like it should.
};

MainstartAssistant.prototype.setup = function()
{

};

MainstartAssistant.prototype.cleanup = function()
{

};

MainstartAssistant.prototype.handleCommand = function(event)
{        
